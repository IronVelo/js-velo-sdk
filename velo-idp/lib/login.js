...
(function (global, factory) {
   ...
   */
  var LoginFlow = _exports["default"] = /*#__PURE__*/function (_Flow) {
    /**
     ...
     */
    function LoginFlow(baseUrl, fetch) {
      var _this;
      _classCallCheck(this, LoginFlow);
      _this = _callSuper(this, LoginFlow, ['/login', 'LoginFlow', baseUrl, fetch]);
      _this.mfaTypes = [];
      return _this;
    }
     ...
     */
    _inherits(LoginFlow, _Flow);
    return _createClass(LoginFlow, [{
      key: "hello",
      value: (function () {
        var _hello = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(username, password) {
          var response, data;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                this._checkState(STATES.INIT, 'The login flow has already been started.');
                _context.next = 3;
              ...
              case 6:
                data = _context.sent;
                this.state = STATES.INIT_MFA;
                this.mfaTypes = data[0];
                this.permit = data[1];
                return _context.abrupt("return", this.mfaTypes);
              case 11:
              case "end":
      ...
      key: "_prepareMfa",
      value: (function () {
        var _prepareMfa2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(mfaType, successState) {
          var response, data;
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                throw new _errors.MfaNotSetUpError(mfaType);
              case 2:
                _context2.next = 4;
                return this._fetch_with_permit(_defineProperty({}, this.state, mfaType));
              case 4:
              ...
              case 7:
                data = _context2.sent;
                // Infallible due to the initial check.
        ...
        function _prepareMfa(_x3, _x4) {
          return _prepareMfa2.apply(this, arguments);
        }
        return _prepareMfa;
      }()
      /**
      ...
      key: "prepareTotp",
      value: function prepareTotp() {
        this._checkState([STATES.INIT_MFA, STATES.RETRY_INIT_MFA], 'Invalid state for preparing TOTP.');
        return this._prepareMfa(TOTP, STATES.CHECK_TOTP);
      }
      ...
      key: "prepareSms",
      value: function prepareSms() {
        this._checkState([STATES.INIT_MFA, STATES.RETRY_INIT_MFA], 'Invalid state for preparing SMS.');
        return this._prepareMfa(SMS, STATES.CHECK_SIMPLE_MFA);
      }
      ...
      key: "prepareEmail",
      value: function prepareEmail() {
        this._checkState([STATES.INIT_MFA, STATES.RETRY_INIT_MFA], 'Invalid state for preparing email.');
        return this._prepareMfa(EMAIL, STATES.CHECK_SIMPLE_MFA);
      }
       ...
       * @returns {Promise<Array<Number> | void>} - The token if successful, `void` if the user must retry.
       *
       * @throws {InvalidStateError} If the current state is not CHECK_SIMPLE_MFA.
       * @throws {HttpError} If the request fails.
       * @throws {PreconditionFailure} If the permit has expired.
       */
    }, {
      key: "verifyOtp",
      value: (function () {
        var _verifyOtp = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(code) {
          var response, data;
          return _regeneratorRuntime().wrap(function _callee3$(_context3) {
            while (1) switch (_context3.prev = _context3.next) {
              case 0:
                this._checkState([STATES.CHECK_SIMPLE_MFA, STATES.CHECK_TOTP], 'Invalid state for checking simple MFA.');
                _context3.next = 3;
                return this._fetch_with_permit(_defineProperty({}, this.state, code));
              case 3:
              ...
              case 6:
                data = _context3.sent;
                if (!data[0].issue_token) {
                  _context3.next = 12;
                  break;
                }
                this.state = STATES.TERMINAL;
                return _context3.abrupt("return", data[0].issue_token);
              case 12:
                this.state = STATES.RETRY_INIT_MFA;
                this.permit = data[1];
              case 14:
              case "end":
